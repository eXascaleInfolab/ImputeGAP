...
### Motion Sensor Dataset (Human Activity Recognition)
...
The dataset contains multi-modal activity diversity, including five activities with distinct biomechanical signatures, movement frequencies, and intensity profiles for robust classification, within-athlete consistency that controls for individual variation and isolates activity-specific patterns, equipment-mediated activities like biking and skiing that alter movement dynamics, and cross-modal similarities, such as walking versus running and skiing versus roller skiing, that present nuanced challenges for recognition algorithms.

<br />


### Sport Activity Dataset (Multi-Modal Exercise Recognition)
